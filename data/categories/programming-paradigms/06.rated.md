...
- text: "Procedural programming: Do this, then that. Object-oriented programming: Ask Bob to do it. Functional programming: Describe what 'done' looks like and hope it happens."
  explanation: "This uses comparative structure to highlight the philosophical differences between paradigms through increasingly abstract (and absurd) descriptions, building from concrete to philosophical, creating humor through escalating detachment from direct action."
  rating: 8
